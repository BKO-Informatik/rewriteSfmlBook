...
, mSpawnPositions( mWorldView.getSize().x / 2.f, mWorldBounds.height - mWorldView.getSize().y / 2.f )
, mScrollSpeed( -50.f )
, mPlayerAircraft( nullptr ) {
    ...
    // Prepare the view
    mWorldView.setCenter(mSpawnPositions);
}
...
void World::buildScene() {
    ...
    mPlayerAircraft->setPosition( mSpawnPositions );
